...
**
** Created: Sat May 31 13:55:45 2014
...
void TripServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData TripServer::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TripServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_TripServer,
      qt_meta_data_TripServer, &staticMetaObjectExtraData }
};
